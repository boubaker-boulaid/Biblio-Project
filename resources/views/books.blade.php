                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <a href={{ route('details')}}
                                        class="text-lg font-semibold text-gray-900 hover:text-blue-600">Livre 1</a>
                            ...
                            <div class="text-right">
                                <a href={{ route('details')}} class="text-blue-600 hover:underline">Détails</a>
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <a href={{ route('details')}}
                                        class="text-lg font-semibold text-gray-900 hover:text-blue-600">Livre 2</a>
                                    <ul class="flex flex-wrap gap-x-4 text-sm text-gray-500 mt-1">
                                        <li>Science</li>
                                        <li>Physics</li>
                                        <li>par Jane Doe</li>
