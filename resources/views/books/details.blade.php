                            ...
                            <div class="flex-grow">
                                ...
                                <div class="mt-6 border-t border-gray-200 pt-6">
                                    ...
                                    <p class="mt-4 text-gray-600 leading-relaxed">
                                        A few months back I bought a license for Laravel Spark but never got around to using
                                        it. To be honest I find the thought of using PHP a little hard since I have been
                                        working on Django/Flask apps for so long but Laravel Spark framework does address a
                                        lot of my issues with frameworks like Django and Flask. It is very opinionated and
                                        takes care of a lot of bolier-plate tedium.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-6 rounded-lg border border-gray-200 shadow-md">
                        ...
                        <ul class="mt-4 space-y-3 text-gray-600">
                            ...
                            <li class="flex justify-between"><span>Auteur:</span> <span
                                    class="font-medium text-gray-900">Chain Coder</span></li>
